# TechGen Ecommerce
TechGen is an Ecommerce project based on React js and JSON Server.

# How to run this project

1. Download the project as ZIP and extract files.
2. Select Server as current directory from terminal and in terminal, enter npm -install and then npm start.
