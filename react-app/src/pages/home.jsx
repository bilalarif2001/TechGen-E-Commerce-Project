...
function Home() {
  ...
  return (
    <div class="container mx-auto">
      {/* Banner Start */}
      <div class=" w-full m-2 relative bg-cover bg-no-repeat bg-center">
      ...
      <div class="container py-16 m-5">
        ...
        <div class="lg:w-10/12 grid md:grid-cols-3 gap-3 lg:gap-6 mx-auto justify-center ">
          {/* First feature*/}
          <div class="border-primary border rounded-lg px-8 lg:px-3 lg:py-6 py-4 flex justify-center items-center gap-5 shadow-md hover:shadow-xl transition hover:text-rose-500">
...
{/* Featured Items */}
    <div class="container pb-16 mx-auto">
        <h2 class="text-2xl md:text-3xl font-medium text-gray-800 uppercase mb-6">FEATURED ITEMS</h2>
    ...
    <div class="container mb-16">
      ...
      {/* Featured Items */}
    <div class="container pb-16 mx-auto">
        <h2 class="text-2xl md:text-3xl font-medium text-gray-800 uppercase mb-6">Recommended For You</h2>
        {/* <!-- product wrapper --> */}
        <div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-6">
            {/* <!-- single product --> */}
