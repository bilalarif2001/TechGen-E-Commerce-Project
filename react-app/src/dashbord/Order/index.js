...
const Order = () => {
  ...
  const OrderConfirm = (e) => {
    ...
    const updateData = {
      ...e,
      status: "accepted",
      orderdescription: "Your Order is Accepted",
    };
    console.log(e)
    fetch(`http://localhost:5000/orders/updateOrder/${e.id}`, {
      method: "PUT",
  ...
  const OrderCancel = (e) => {
    ...
    const updateData = {
      ...e,
      status: "Rejected",
      orderdescription: "Your Order is Rejected",
    };
    fetch(`http://localhost:5000/orders/${e.id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          <p className="text-2xl -mt-6 text-blue-500">OrderDetails</p>
              ...
              orderData.map((item, id) => (
                <div key={id} className="flex justify-between  w-full">
                  <p className=" text-lg font-semibold text-gray-600">
                    <span className="mr-3">Order Email:</span>
                    {item.id}
                  </p>
                  <p className=" text-lg font-semibold text-gray-600">
                    {item.email}
          ...
          <div className="mt-3">
                ...
                {orderData.length > 0 &&
                  orderData[0].products.map((i, id) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6 text-lg font-medium text-gray-600">
                        ${i.price}
                      </td>
                    </tr>
                  ))}
            ...
            <h1 className="mt-2  text-lg font-medium text-gray-600 ">
              <span className="mr-3 font-medium">Total Amount:</span>
