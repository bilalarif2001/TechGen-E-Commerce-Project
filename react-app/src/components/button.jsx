...
else if (props.varient==="yellow") varient="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4"

    return (
        <button className={varient} onClick={props.onClick}>{props.children}</button>
  )
}
